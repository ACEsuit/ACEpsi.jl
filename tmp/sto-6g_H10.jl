...
cluster = Nel
ord = 2
wf, spec, spec1p, disspec = BFwf_chain, spec, spec1p, disspec = BFwf_lux(Nel, Nbf, speclist, bRnl, bYlm, nuclei, ACEpsi.TD.No_Decomposition(); totdeg = totdegree, cluster = cluster, ν = ord)
