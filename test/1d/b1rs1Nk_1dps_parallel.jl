...
@everywhere begin|
    ...
    using ACEpsi.vmc: gradient, laplacian, grad_params, SumH, MHSampler, VMC, gd_GradientByVMC, gd_GradientByVMC_parallel, d1, adamW, sr
    using LuxCore
    using Lux
    using Zygote
...
wf, err_opt, ps = gd_GradientByVMC_parallel(opt_vmc, sam, ham, wf, ps, st)
# @show ps.hidden1.W
