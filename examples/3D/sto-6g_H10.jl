...
# Ref: https://www.basissetexchange.org/, https://link.springer.com/book/10.1007/978-90-481-3862-3: P235
# STO: 0.7790 * e^(-1.24 * r)
...
D = [[(2 * ζ[1][i]/pi)^(3/4) * D[1][i] for i = 1:length(ζ[1])]] * sqrt(2) * 2 * sqrt(pi)
